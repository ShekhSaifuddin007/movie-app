                    ...
                    <div class="mt-8">
                        <a href="#">
                            @if ($cast['profile_path'])
                                <img src="{{ "https://image.tmdb.org/t/p/w300{$cast['profile_path']}" }}" alt="{{ $cast['name'] }}" class="hover:opacity-75 w-full transition ease-in-out duration-150">
                            @else
                                <img src="{{ "https://via.placeholder.com/300x450.png?text={$cast['name']}" }}" alt="{{ $cast['name'] }}" class="hover:opacity-75 w-full transition ease-in-out duration-150">
                            @endif
                        </a>
