...
{{--            <div class="flex-none">--}}
                <img src="{{ 'https://image.tmdb.org/t/p/w500'.$movie['poster_path'] }}" alt="{{ $movie['title'] }}" class="w-full md:w-96">
{{--            </div>--}}
                    ...
                    @if ($loop->index < 10)
                        <div class="mt-8">
                            <a href="#">
                                ...
                                @else
                                    <img src="{{ 'https://via.placeholder.com/300x450.png?text='.$cast['name'] }}" alt="{{ $cast['name'] }}" class="hover:opacity-75 transition ease-in-out duration-150">
                                @endif
                            </a>
