...
<nav class="border-b border-gray-800 sticky bg-gray-900 top-0 z-50">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
        <ul class="flex items-center">
            ...
            <li class="sm:ml-16 ml-6">
                <a href="{{ route('movies.index') }}" class="hover:text-gray-300 text-sm sm:text-base">
                    Movies
                </a>
            </li>
            ...
            <li class="sm:ml-6 ml-3">
                <a href="{{ route('actors.index') }}" class="hover:text-gray-300 text-sm sm:text-base">
                    Actors
                </a>
            </li>
        </ul>
